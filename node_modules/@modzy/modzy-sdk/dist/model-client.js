...
class ModelClient {
  ...
  getModels(modelId = null, author = null, createdByEmail = null, name = null, description = null, isActive = null, isExpired = null, isRecommended = null, lastActiveDateTime = null, expirationDateTime = null, page = null, perPage = 1000, direction = null, sortBy = null) {
  ...
  getModelByName(name) {
    return this.getModels(null, null, null, name, null, true, null, null, null, null, null, 20, null, "name").then(models => {
      logger.debug(`getModelByName(${name}) models ${models.length}`);

      if (models !== null && models.length > 0) {
        if (models.length > 1) {
          return Promise.all(models.map(model => this.getModel(model.modelId))).then(models2 => {
            models2 = models2.map(model => {
